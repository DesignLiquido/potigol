...
describe('Analisador semântico', () => {
    ...
    describe('Cenários de sucesso', () => {
        it('Declaração de inteiro constante com val, dica de tipo e uso da variável', () => {
        ...
        it('Declaração de variável com var e uso', () => {
    ...
    describe('Avisos', () => {
        it('Deve avisar sobre variável não usada', () => {
        ...
        it('Deve detectar corretamente variáveis usadas em reatribuição', () => {
    ...
    describe('Erros', () => {
        it('Analisador não gera erros quando sintaxe está correta', () => {
        ...
        it('Deve detectar divisão por zero em tempo de compilação', () => {
        ...
        it('Detecta modificação de constante via reatribuição', () => {
        ...
        it('Detecta tipo incompatível na declaração de vetor de inteiros', () => {
